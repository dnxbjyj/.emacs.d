...
(defvar company-posframe-active-map
  (let ((keymap (make-sparse-keymap)))
    ...
    ;; Quickhelp keys.
    (define-key keymap (kbd "C-d") 'company-posframe-quickhelp-toggle)
    (define-key keymap (kbd "C-n") 'company-posframe-quickhelp-scroll-up)
    (define-key keymap (kbd "C-p") 'company-posframe-quickhelp-scroll-down)
