...
(global-set-key (kbd "<f9>") '(lambda() (interactive) (find-file "~/.emacs.d/site-lisp/config/init-config.el")))

;; 快速打开config目录
(global-set-key (kbd "C-<f9>") '(lambda() (interactive) (dired "~/.emacs.d/site-lisp/config/")))
...
;; 加载当前文件
(global-set-key (kbd "C-<f11>") 'load-file)

;; 快速提交git代码（need auto-commit.bat file in ~/.emacs.d/ directory）
(global-set-key (kbd "<f5>") (lambda() (interactive) (shell-command "start auto-commit.bat")))
